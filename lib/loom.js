...
// A string to prepend to all measurement names sent to Loom.
var globalPrefix = "";

// Loom web service can't ignore individual broken metrics
...
var flush_stats = function loom_flush(ts, metrics) {
